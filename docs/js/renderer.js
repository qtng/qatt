...
const defaultSvgDefs = `<svg xmlns="http://www.w3.org/2000/svg"
	...
	<path id="v-xsmall" d="M35 10 c0 0 -7 40 -20 63 M10 77 l36 -10 M43 53 l8 20"/>
    	...
    	<path id="qt2" d="M2 90 c12 0 12 14 0 14 c-12 0 -12 -14 0 -14"/>
    	<path id="qt3" d="M2 -5 m0 14 c-12 0 -12 -14 0 -14"/>
    	<path id="qt4" d="M2 -5 c12 0 12 14 0 14 c-12 0 -12 -14 0 -14 m7 7 h3"/>
    	<path id="qt5" d="M98 -5 c12 0 12 14 0 14 c-12 0 -12 -14 0 -14"/>
    	<path id="qt6" d="M98 90 m0-3v3 c12 0 12 14 0 14"/>
		<path id="qt7" d="M98 90 m0-3v3 c12 0 12 14 0 14 c-12 0 -12 -14 0 -14"/>
