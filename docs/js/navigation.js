    ...
    const navConfig = {
        ...
        sections: [
            ...
            },
            {
                ...
                linkClass: "link-qatt",
                links: [
                    { name: "Practise QATT", url: "/qatt/app.html", icon: "bi-mortarboard" },
        ...
        header.innerHTML = `
            <div class="container-fluid">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="/qatt/app.html" class="${isQuiz?'d-none':''} badge rounded-pill border border-success text-success bg-transparent text-decoration-none small me-2 py-1 px-2">
                        🏆 ${highscore}
                    </a>
